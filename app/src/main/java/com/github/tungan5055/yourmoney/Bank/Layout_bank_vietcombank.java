...
import com.github.tungan5055.yourmoney.Report.Layout_Baocao_Bank_VietCombank;
...
public class Layout_bank_vietcombank extends FragmentActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_bank_viecombank);
        ...
        bankControl.open();
        list = bankControl.laydsbank_vietcom(stk);
        txtsd.setText(bankControl.gettien_vietcom().toString());
        bankControl.close();
    ...
    private View.OnClickListener clickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.fab_home:
                    Intent intent = new Intent(Layout_bank_vietcombank.this, MainActivity.class);
                    startActivity(intent);
                    break;
                case R.id.fab_baocao:
                    Intent intent0 = new Intent(Layout_bank_vietcombank.this, Layout_Baocao_Bank_VietCombank.class);
