 ...
 */
public class Layout_Baocao_Bank extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_bank_baocao);
        loadActivity();
    }
    @Override
...
public void loadActivity(){
    ...
    bankControl.open();
    try {
        thu = bankControl.gettien_thu((String) textmon.getText(), getIntent().getStringExtra("stk"));
        chi = bankControl.gettien_chi((String) textmon.getText(), getIntent().getStringExtra("stk"));
    ...
    private View.OnClickListener clickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.fab_home:
                    Intent intent1 = new Intent(Layout_Baocao_Bank.this, MainActivity.class);
                    startActivity(intent1);
                    break;
                case R.id.fab_chitiet:
                    Intent intent2 = new Intent(Layout_Baocao_Bank.this, layout_details_bank0.class);
