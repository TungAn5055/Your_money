...
public class layout_details_bank extends AppCompatActivity {
    private ThuChiDAO dao;
    TextView tienthu, tienchi, kq, txtthumax, txtchimax, txtmoneythu, txtmoneychi, txtphandinh;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_details_report);
        ...
        txtmoneythu.setText(String.valueOf(defomat.format(dao.getmaxthumoney(mon))));
        txtmoneychi.setText(String.valueOf(defomat.format(dao.getmaxchimoney(mon))));
    }
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.fab_chitiet:
                    Intent intent0 = new Intent(layout_details_bank.this, Layout_Baocao.class);
                    startActivity(intent0);
                    break;
                case R.id.fab_home:
                    Intent intent1 = new Intent(layout_details_bank.this, MainActivity.class);
