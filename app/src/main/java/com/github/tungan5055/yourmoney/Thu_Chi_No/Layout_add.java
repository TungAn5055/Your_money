...
/**
 * Created by an on 4/14/2016.
 */
public class Layout_add extends FragmentActivity implements OnDateSetListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        linearLayout_date = (LinearLayout)findViewById(R.id.btndate0);
        ...
        linearLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent_nhomo = new Intent(Layout_add.this, layout_list_item.class);
        ...
        editsotien0.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                try {
                    ...
                    Toast.makeText(Layout_add.this, e.toString(), Toast.LENGTH_SHORT).show();
                }
            }
        ...
        findViewById(R.id.btndate0).setOnClickListener(new View.OnClickListener() {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btnexit:
                Intent intent = new Intent(Layout_add.this, MainActivity.class);
                startActivity(intent);
                break;
            case R.id.btnok:
                if(isValidDate(String.valueOf(editDate0.getText())) == 0){
                    Toast.makeText(Layout_add.this, "Bạn đã nhập sai định dạng ngày, hãy click vào button bên cạnh để chọn ngày.", Toast.LENGTH_SHORT).show();
                    break;
                }
                if(editDate0.getText().equals("") || editsotien0.getText().equals("") || texttenkhoan0.getText().equals("")){
                    Toast.makeText(Layout_add.this, "Vui lòng nhập đủ thông tin", Toast.LENGTH_SHORT).show();
                }else {
                    ...
                    dao.themthuchi(dto);
                    dao.close();
                    Intent intent0 = new Intent(Layout_add.this, MainActivity.class);
                    startActivity(intent0);
                }
                break;
            case R.id.btnnhom:
                Intent intent_nhom = new Intent(Layout_add.this, layout_list_item.class);
